            ...
            <div class="col-md-6 m-b-30">
                    ...
                    <div class="p-b-13">
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-12">
                                ...
                                <p class="color1"><?= $model->alamat_pembeli ?>
                                    KODEPOS () </p>
                            </div>
                            <!-- <div class="col-md-12">
                                <h5 class="text-black p-b-10">Alamat Pengiriman</h5>
                ...
                <div class="produk p-b-40 m-l-0 m-r-0">
                    <div class="produk-item row m-b-30 m-lr-0">
                        ...
                        <?php
                        foreach ($keranjang_pesan as $kersan) {
                        ...
                        ?>
                            <?php foreach ($produk_pesan as $prosan) { ?>
                                <div class="col-md-2 row m-lr-0 p-lr-0">
                                    <div class="img" style="background-image:url('<?= \Yii::$app->request->baseUrl . "/uploads/banner_produk/" . $prosan->foto_banner ?>')"></div>
                                </div>
                                <div class="col-md-6 hidesmall">
                                    <div class="p-l-10 font-medium"><?= $prosan->nama ?><br /><small class='text-danger'>Warna: <?= $kersan->variant1 ?> Ukuran: <?= $kersan->variant2 ?></small></div>
                                </div>
                        ...
                        <div class="col-4 font-medium text-info">
                            <p> <?= \app\components\Angka::toReadableHarga($totalharga); ?></p>
                        </div>
                    </div>
                </div>
            </div>
