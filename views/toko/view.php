...
<div class="giiant-crud toko-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="glyphicon glyphicon-list"></span> ' . 'Daftar Toko', ['index'], ['class'=>'btn btn-default']) ?>
    </p>
    ...
    <div class="box box-info">
        <div class="box-body">
            <?php $this->beginBlock('app\models\Toko'); ?>
...
[
    ...
    'value' => ($model->user ? 
        ...
        Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'Toko'=>['id_user' => $model->id_user]])
        : 
...
<div style='position: relative'><div style='position:absolute; right: 0px; top 0px;'>
  ...
  <?= Html::a(
            ...
            ['produk/create', 'Produk' => ['toko_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div></div><?php Pjax::begin(['id'=>'pjax-Produks', 'enableReplaceState'=> false, 'linkSelector'=>'#pjax-Produks ul.pagination a, th a', 'clientOptions' => ['pjax:success'=>'function(){alert("yo")}']]) ?>
<?= '<div class="table-responsive">'
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        ...
        $params['Produk'] = ['toko_id' => $model->primaryKey()[0]];
        return $params;
    },
    'buttons'    => [
...
<?php $this->endBlock() ?>
    ...
    'content' => $this->blocks['app\models\Toko'],
    'active'  => true,
],[
