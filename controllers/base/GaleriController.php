...
public function actionCreate()
    {
        ...
        try {
            if ($model->load($_POST)) {
                ...
                $response = $this->uploadFile($foto,'galeri');
...
public function actionUpdate($id)
    {
        ...
        if ($model->load($_POST)) {
            ...
            if ($foto != NULL) {
                ...
                // }
                // $path = Yii::getAlias("@app/web/uploads/galeri/") . $model->foto;
                if ($oldfoto != NULL) {

                    // $foto->saveAs($path);
                    // unlink(Yii::$app->basePath . '/web/uploads/galeri/' . $oldfoto);
                    $this->deleteFile("galeri",$oldfoto);
                }
                //  else {
                //     $foto->saveAs($path);
                // }
