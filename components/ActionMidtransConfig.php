...
class ActionMidtransConfig
{
    ...
    {
        return ActionMidtransConfig::$isProduction ?
        ActionMidtransConfig::PRODUCTION_BASE_URL : ActionMidtransConfig::SANDBOX_BASE_URL;
    }
    ...
    {
        return ActionMidtransConfig::$isProduction ?
        ActionMidtransConfig::SNAP_PRODUCTION_BASE_URL : ActionMidtransConfig::SNAP_SANDBOX_BASE_URL;
    }
}
